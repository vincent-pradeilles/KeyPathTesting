...
public func == <Type, Value: Equatable>(property: KeyPath<Type, Value>, constant: Value) -> Assertion<Type> {
...
public func ~= <Type, Value> (_ pattern: ClosedRange<Value>, _ property: KeyPath<Type, Value>) -> Assertion<Type> {
    return Assertion { instance, file, line in
        XCTAssert(pattern ~= instance[keyPath: property], file: file, line: line)
    }
}

public func < <Type, Value: Comparable>(property: KeyPath<Type, Value>, constant: Value) -> Assertion<Type> {
    return Assertion { instance, file, line in
...
public prefix func ! <Type>(property: KeyPath<Type, Bool>) -> Assertion<Type> {
    return Assertion { instance, file, line in
